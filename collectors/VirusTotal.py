...
class VirusTotal:
    ...
    def get_ip_report(self, ip_address):
        ...
        data_dict = {'ipaddress':ip_address, 
                     'whois':whois,
    ...
    def get_domain_report(self, domain):
        ...
        last_analysis_results = domain_report['data']['attributes']['last_analysis_results']
        analysis_list = []
        malicious_count = 0
        for index, key in last_analysis_results.items():
            if isinstance(key, dict):
    ...
    def get_url_report(self, url):
        ...
        last_analysis_results = url_report['data']['attributes']['last_analysis_results']
        analysis_list = []
        malicious_count = 0
        for index, key in last_analysis_results.items():
            if isinstance(key, dict):
    ...
    def get_file_report(self, file_hash):
        ...
        data_dict = {'filename': filename, 'lastanalysisdate':lastanalysisdate,'filereputation':filereputation}
        return data_dict